...
ripgrep_search(){
    RG_PREFIX="rg --ignore-file='$HOME/Library/*' --ignore-file='/Library/*'--column --line-number --no-heading --color=always --dfa-size-limit 4G --smart-case "
...
#  cat temp.patch | grep '@@ ' | fzf \                                          
#     --preview 'python3.11 p.py temp.patch "{}" |  bat --color=always --plain --language=Diff' | @ -I{} python3.11 p.py temp.patch "{}"